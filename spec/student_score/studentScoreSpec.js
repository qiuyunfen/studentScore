describe('studentScore', function () {
    ...
    it('should get class info include query studentno', function () {
        ...
        let findstu = null;
        findstu = allcls.find(cl => cl.stuScore.filter(stu => stu.student.stuno == stuno));
    ...
    it('shoule update new class info when classinfo isExit', function () {
        ...
        let findcl = allcls.find(cl => cl.stuScore.filter(stu => stu.student.stuno == stuno));
        let newcl = findcl.updateNewClass([new Class(360, 360, 1).addStuScore(stu1)]);
    ...
    it('shoule update new class info when classinfo not exit', function () {
        ...
        let findcl = allcls.find(cl => cl.stuScore.filter(stu => stu.student.stuno == stuno));
        let newcl = findcl.updateNewClass([new Class(360, 360, 2).addStuScore(stu1)]);
